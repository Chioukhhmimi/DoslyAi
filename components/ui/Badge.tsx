...
export function Badge({ label, variant = 'default', size = 'md' }: BadgeProps) {
  return (
    <View style={[styles.base, { backgroundColor: BG[variant] }, size === 'sm' ? styles.sm : styles.md]}>
      <Text style={[styles.text, { color: TEXT_COLOR[variant] }, size === 'sm' ? styles.textSm : styles.textMd]}>
        {label}
      </Text>
    </View>
  );
